...
def find_best_run_id(run_name: str) -> str:
    best_run = mlflow.search_runs(order_by=['metrics.test_mse ASC']).iloc[0]
...
def register_model(run_id: str, model_name: str = "restaurant_recommender"):
...
if __name__ == "__main__":
    ...
    model_version = register_model(run_id=run_id)
    transit_model(
